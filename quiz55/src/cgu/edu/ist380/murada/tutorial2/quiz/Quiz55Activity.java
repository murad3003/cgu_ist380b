package cgu.edu.ist380.murada.tutorial2.quiz;
...
public class Quiz55Activity extends Activity {
    ...
    public void init() {
    	questions = new String[]{"What is the capital of Egypt?", "What class are you in right now?", "Waht your name?"};
    	answers = new String[]{"Cairo","IST380", "Abdullah"};
    	currentQuestion = -1;
